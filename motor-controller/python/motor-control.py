...
MOTOR_LP = 8 # GPIO pin 8, Controls the input to the positive terminal of the left motor
MOTOR_LN = 11 # GPIO pin 11, Controls the input to the negative terminal of the left motor
