 ...
 * @param on When the signal should transition from low to high
 * @param off When the signal should transition from high to low
 */
int pwm_driver_pca9685_set_pwm(pwm_driver_pca9685_t* driver, uint8_t pin, int on, int off);
 ...
 * @param off When the signal should transition from high to low
 */
int pwm_driver_pca9685_set_pwm_all(pwm_driver_pca9685_t* driver, int on, int off);
