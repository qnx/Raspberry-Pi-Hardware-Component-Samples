...
typedef ws2811_led_t CRGB;

// macros for constructing CRGB / CRGBW color conversion
#define CRGB(red,green,blue) (red << LED_SHIFT_R | green << LED_SHIFT_G | blue << LED_SHIFT_B);
#define CRGBW(red,green,blue,white) (white << LED_SHIFT_W + red << LED_SHIFT_R | green << LED_SHIFT_G | blue << LED_SHIFT_B);

#define CRGBW_red(led) ((led >> LED_SHIFT_R) & 0xff)
#define CRGBW_green(led) ((led >> LED_SHIFT_G) & 0xff)
#define CRGBW_blue(led) ((led >> LED_SHIFT_B) & 0xff)
#define CRGBW_white(led) ((led >> LED_SHIFT_W) & 0xff)
