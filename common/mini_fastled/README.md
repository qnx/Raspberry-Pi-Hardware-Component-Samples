...
This library consists of many categories of APIs.  Documentation of the APIs is 
still in progress so highlights of the different APIs will be added here as soon as possible.
